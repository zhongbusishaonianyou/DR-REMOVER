...
def evaluate(gt, estimate, voxelsize=0.2):
    ...
    print(num_gt['static'])
    print(num_static_preserved)
    
    print(num_gt['dynamic'])
    print(num_dynamic_preserved)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt', default='/home/zgy/ROS/DR_REMOVER/src/DR-REMOVER-master/DR-REMOVER-master/gt_label/apollo_04.pcd', type=str)
    parser.add_argument('--est', default='/home/zgy/ROS/DR_REMOVER/src/DR-REMOVER-master/DR-REMOVER-master/results/Apollo/apollo_04_result.pcd', type=str)
